        ...
        <div className="container mt-3">
            <div className="row">
                <div className="col-11 col-md-6 offset-md-3 text-center mt-5 mb-5">
                    <br />
                    <h1 style={{ color: "#c084fc" }}>Sobre Nós</h1>
                    <br />
                    <h5>Oque nós somos, quais as nossas funcionalidades e vantagens? </h5>
                    <hr />
                    <br />
                    <h1 style={{ color: "#c084fc" }}>Oque nós somos?</h1>
                    <br />
                    ...
                    <br />
                    <hr />
                    <h1 style={{ color: "#c084fc" }}>Funcionalidades</h1>
                    <br />
                    <h3 style={{ color: "#c084fc" }}>1. Cadastro e Perfil de Usuário</h3>
                    <br />
                    <p>- Os usuários podem realizar um cadastro na plataforma, criando um perfil personalizado.
                    <br /><br />
                    - É possível incluir informações como habilidades técnicas, experiência e projetos realizados. 
                    <br /><br />
                    ...
                    <br /><br />
                    <h3 style={{ color: "#c084fc" }}>2. Compartilhamento e Acesso a Códigos</h3>
                    <br /> 
                    ...
                    <br /><br />
                    <h3 style={{ color: "#c084fc" }}>3. Perfil de Empresa</h3>
                    <br />
                    <p>-Empresas podem criar perfis específicos na plataforma, marcados como "perfil de empresa".</p>
                    <br />
                    <p>- Esses perfis funcionam como uma vitrine para apresentar a empresa e seus interesses.</p>
                    <br />
                    <p>- Empresas podem utilizar esses perfis para buscar profissionais, divulgar oportunidades e estabelecer negociações.</p>
                    <br /><br />
                    <hr />
                    <h1 style={{ color: "#c084fc" }}>Vantagens</h1>
                    <br />
                    <p>- Comunidade colaborativa: Incentiva o compartilhamento de conhecimento e a troca de experiências.</p>
                    <br /><br />
                    <p>- Visibilidade para profissionais e empresas: Ambos podem se destacar e atrair oportunidades.</p>
                    <br /><br />
                    <p>- Acesso a uma vasta gama de códigos: Permite aprender com exemplos de outros desenvolvedores e aprimorar habilidades técnicas.</p>
                    <br /><br />
                </div>
            </div>
        </div>
